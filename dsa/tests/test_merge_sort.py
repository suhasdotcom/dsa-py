...
def test_empty_element_descending_iterable():
    assert merge_sort.merge_sort([], descending=True) == []


def test_one_element_descending_iterable():
    assert merge_sort.merge_sort([1], descending=True) == [1]


def test_three_element_descending_iterable():
    assert merge_sort.merge_sort([1, 4, 2], descending=True) == [4, 2, 1]


def test_four_element_descending_iterable():
    assert merge_sort.merge_sort([1, 4, 2, 3], descending=True) == [4, 3, 2, 1]


def test_two_element_descending_iterable():
    assert merge_sort.merge_sort([2, 1], descending=True) == [2, 1]


def test_four_sparse_element_descending_iterable():
    assert merge_sort.merge_sort([-100, 400, -212, 13452], descending=True) == [13452, 400, -100, -212]
...
def test_ten_element_descending_iterable_sort_should_be_correct():
    ...
    assert merge_sort.merge_sort(a_iterable, descending=True) == sorted_iterable
